...
Interface.Slider = function() {
  Interface.extend(this, {
    ...
    draw : function() {
      ...
      this.ctx.strokeStyle = this._fill();
  ...
  Interface.extend(this, {
    ...
    draw : function() {
      ...
      for(var i = 0; i < this.children.length; i++) {
        ...
        this.ctx.fillText("x", x + child.x, y + child.y);

        //EXtended to draw lines
        this.ctx.beginPath();

        this.ctx.moveTo(child.x,y);
        this.ctx.lineTo(child.x, y + height);
        this.ctx.moveTo(x,child.y);
        this.ctx.lineTo(x + width, child.y);
        this.ctx.stroke();
        this.ctx.closePath();
